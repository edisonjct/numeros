    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="pages/forms/usuarios.php"><i class="fa fa-chevron-right"></i> Registro</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="pages/forms/empresa.php"><i class="fa fa-chevron-right"></i> Empresa</a></li>
